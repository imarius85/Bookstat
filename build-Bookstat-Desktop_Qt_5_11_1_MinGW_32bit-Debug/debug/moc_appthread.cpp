...
QT_MOC_LITERAL(5, 60, 16) // "threadProcessing"

    },
    "AppThread\0threadError\0\0threadFinished\0"
    "std::shared_ptr<Book>\0threadProcessing"
};
...
void AppThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->threadProcessing((*reinterpret_cast< std::shared_ptr<Book>(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            using _t = void (AppThread::*)(std::shared_ptr<Book> , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AppThread::threadProcessing)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void AppThread::threadProcessing(std::shared_ptr<Book> _t1, int _t2)
{
